...
import * as strings from 'BiomarinCss2ApplicationCustomizerStrings';
...
const LOG_SOURCE: string = 'BiomarinCss2ApplicationCustomizer';
 ...
 */
export interface IBiomarinCss2ApplicationCustomizerProperties {
  // This is an example; replace with your own property
  testMessage: string;
}

/** A Custom Action which can be run during execution of a Client Side Application */
export default class BiomarinCss2ApplicationCustomizer
  extends BaseApplicationCustomizer<IBiomarinCss2ApplicationCustomizerProperties> {
