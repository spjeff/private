          ...
          <div class="csg-content" id="a">
            <table border=0>
              ...
              <tr>
                ...
                <td>
                  <select ng-model="d.selectState" ng-options="x.abbr as x.state for x in states" onchange="setDropdown(this, 'selectState')"></select>

                  <input type="text" maxlength="150" name="" id="" ng-model="d.selectStateOther" placeholder="Type state here"
                    ng-show="d.selectState == 'OT'" />
                </td>
              ...
              <tr>
                ...
                <td>
                  <select class="chosen-select" name="" id="" ng-model="d.selectCountry" ng-options="x.abbr as x.country for x in choiceCountries"
                    onchange="setDropdown(this, 'selectCountry')"></select>
                  <input type="text" maxlength="150" name="" id="" ng-model="d.selectCountryOther" placeholder="Type country here"
                    ng-show="d.selectCountry == 'OT'" />
                </td>
              ...
              <tr>
                <td class="csg-label">State/Prov</td>
                <td>
                  <select class="chosen-select" name="" id="" ng-model="d.physician.state" ng-options="x.abbr as x.state for x in states"
                    onchange="setDropdown(this, 'physician.state')"></select>
                  <input type="text" maxlength="150" name="" id="" ng-model="d.physician.StateOther" placeholder="Type country here"
                    ng-show="d.physician.state == 'OT'" />
                </td>
                <td class="csg-label">Postal Code</td>
                <td>
              ...
              <tr>
                <td class="csg-label">Country</td>
                <td>
                  <select class="chosen-select" name="" id="" ng-model="d.physician.country" ng-options="x.abbr as x.country for x in choiceCountries"
                    onchange="setDropdown(this, 'physician.country')"></select>
                  <input type="text" maxlength="150" name="" id="" ng-model="d.physician.CountryOther" placeholder="Type country here"
                    ng-show="d.physician.country == 'OT'" />
                </td>
              ...
              <tr>
                ...
                <td>
                  <input type="text" datepicker name="" id="" ng-model="d.injectRow[d.inject].injectionDate"
                    ng-disabled="d.visit != 0" placeholder="mm-dd-yyyy" ng-class="{'csg-required-field': !d.injectRow[d.inject].injectionDate && d.visit == 0}" />
                  <i class="fa calendar-0"></i>
                </td>
              </tr>
                          ...
                          <tr>
                            <td>
                              <input type="text" datepicker name="" id="" ng-model="r.startDate"
                                ng-class="{'csg-invalid' : !r.startDate}" placeholder="mm-dd-yyyy" />
                              <i class="fa calendar-0"></i>
                            </td>
                            <td>
            ...
            <table>
              ...
              <tr>
                ...
                <td>
                  ...
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.appearance"
                    size="10">
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <!-- <select ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.color" ng-options="x for x in choiceUrinalysis"></select> -->
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.color"
                    size="10">
                </td>
                ...
                <td>
                  ...
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.gravity"
                    size="10">
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.clarity"
                    size="10">
                </td>
                ...
                <td>
                  ...
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.ph" size="10">
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.bili"
                    size="10">
                </td>
                ...
                <td>
                  ...
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.ketones"
                    size="10">
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.nitrates"
                    size="10">
                </td>
                ...
                <td>
                  <!-- <select ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.urinewbc" ng-options="x for x in choiceUrinalysis"></select> -->
                    ...
                    <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.urinewbc"
                      size="10">/HPF
              ...
              <tr>
                ...
                <td>
                  ...
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.leuk"
                    size="10">
                </td>
                ...
                <td>
                  ...
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.rbc"
                    size="10">/HPF
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.glucose"
                    size="10">
                </td>
                ...
                <td>
                  ...
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.epithetial"
                    size="10">/HPF
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.protein"
                    size="10">
                </td>
                ...
                <td>
                  ...
                  <input type="text" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.bacteria"
                    size="10">/HPF
                </td>
              </tr>
              <!-- <tr>
              ...
              <tr>
                <td class="csg-label">General Notes</td>
                <td colspan="4">
                  <textarea ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.notes" name="" id="" cols="60"
                    rows="10"></textarea>
                </td>
              </tr>
            </table>
          ...
          <div class="csg-content" id="e">
            <table border="0">
              ...
              <tr>
                ...
                <td class="csg-wrap">
                  <input type="text" size="10" ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.wbc" />thousand/uL
                </td>
                <td class="csg-label">RDW</td>
                <td>
                  <input type="text" size="10" ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.rdw" />%
                </td>
              </tr>
              ...
              <tr>
                ...
                <td class="csg-wrap">
                  <input type="text" size="10" ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.rbc" />million/uL
                </td>
                <td class="csg-label">MCHC</td>
                <td>
                  <input type="text" size="10" ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.mchc" />g/dL
                </td>
              </tr>
              <tr>
                <td class="csg-label">Hbg</td>
                <td class="csg-wrap">
                  <input type="text" size="10" ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.hbg" />g/dL
                </td>
                <td class="csg-label">MPV</td>
                <td>
                  <input type="text" size="10" ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.mpv" />fL
                </td>
              </tr>
              <tr>
                <td class="csg-label">Hct</td>
                <td class="csg-wrap">
                  <input type="text" size="10" ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.hct" />%
                </td>
                <td class="csg-label">Platelet Count</td>
                <td>
                  <input type="text" size="10" ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.platelet" />Thousand/uL
                </td>
              </tr>
              <tr>
                <td class="csg-label">MCV</td>
                <td class="csg-wrap">
                  <input type="text" size="10" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.mcv" />fL
                </td>
                <td class="csg-label">MCH</td>
                <td>
                  <input type="text" size="10" name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.mch" />fL
                </td>
              </tr>
              <tr>
                <td class="csg-label">General Notes</td>
          ...
          <div class="csg-content" id="f">
            <table>
              ...
              <tr>
                ...
                <td class="csg-wrap">
                  <select name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.collected"
                    ng-options="x for x in choiceCollection"></select>
                  Collected/Not Collected
                </td>
              </tr>
              ...
              <tr>
                ...
                <td class="csg-wrap">
                  <input type="number" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.glucose" />
                  mg/dL
                </td>
                <td class="csg-label">Chloride</td>
                <td class="csg-wrap">
                  <input type="number" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.chloride" />
                  mmol/L
                </td>
              </tr>
              <tr>
                ...
                <td class="csg-wrap">
                  <input type="number" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.calcium" />
                  mg/dL
                </td>
                <td class="csg-label">BUN/Creatinine Ratio</td>
                <td class="csg-wrap">
                  <input type="number" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.bun" />
                  mg/dL
                </td>
              </tr>
              <tr>
                ...
                <td class="csg-wrap">
                  <input type="number" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.albium" />
                  g/dL
                </td>
              ...
              <tr>
                ...
                <td class="csg-wrap">
                  <input type="number" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.totalprotein" />
                  g/dL
                </td>
                <td class="csg-label">ALP</td>
                <td class="csg-wrap">
                  <input type="number" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.alp" />
                  IU/L
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input type="number" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.sodium" />
                  mmol/L
                </td>
                <td class="csg-label">ALT</td>
                <td class="csg-wrap">
                  <input type="number" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.alt" />
                  IU/L
                </td>
              </tr>
              <tr>
                ...
                <td class="csg-wrap">
                  <input type="number" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.potassium" />
                  mmol/L
                </td>
                <td class="csg-label">AST</td>
                <td class="csg-wrap">
                  <input type="number" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.ast" />
                  IU/L
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input type="number" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.co2" />
                  mmol/L
                </td>
                <td class="csg-label">Bilirubin</td>
                <td class="csg-wrap">
                  <input type="number" ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.bili" />
                  mg/dL
                </td>
              </tr>
              <tr>
          ...
          <div class="csg-content" id="g">
            <table>
              ...
              <tr>
                <td class="csg-label">Date of Collection</td>
                <td>
                  <input type="text" datepicker name="" id="" ng-model="d.sero.doc" ng-class="{'csg-required-field': !d.sero.doc}"
                  placeholder="mm-dd-yyyy" />
                </td>
              </tr>
              <tr>
          ...
          <div class="csg-content" id="h">
            <table>
              ...
              <tr>
                <td class="csg-label">Date of Collection</td>
                <td>
                  <input type="text" datepicker name="" id="" ng-model="d.coag.doc" ng-class="{'csg-required-field': !d.coag.doc}"
                  placeholder="mm-dd-yyyy" />
                </td>
              </tr>
              <tr>
                ...
                <td colspan="4">
                  ...
                  <table border="0" width="100%">
                    ...
                    <tr ng-repeat="r in respSAE">
                      ...
                      <td>
                        <a
                          href="https://portal.courtsquaregroup.com/sites/ClientPortal/SiteDirectory/Longeveron/BahamianEDC/Lists/SAE%20Report/Item/displayifs.aspx?List=c723f511-be74-4a08-9c35-256c942f4b8e&Source=https%3A%2F%2Fportal%2Ecourtsquaregroup%2Ecom%2Fsites%2FClientPortal%2FSiteDirectory%2FLongeveron%2FBahamianEDC%2FLists%2FSAE%2520Report%2FAllItems%2Easpx&ContentTypeId=0x01007C3D3621847C0741A3CF69E701AA8BA8&ID={{r.id}}">{{r.Title}}</a>
                      </td>
                      <td>{{r.Created}}</td>
                      <td>
