...
if (!window._spPageContextInfo) {
  window._spPageContextInfo = {
    webAbsoluteUrl: "https://studytst.lgvreg.com/sites/ortho"
  };
}
...
function csgCtl($scope) {
  ...
  vm.listName = "Patient";
  vm.listAudit = "Audit";
  vm.study = "Ortho Study";
  vm.validationMessage = null;
  vm.saving = false;
  vm.singlelocation = false;
  vm.attachFolderUrl = "/sites/ortho/Attach";
  ...
  vm.newSAE = function () {
    var url = 'https://studytst.lgvreg.com/sites/ortho/Lists/SAE%20Report/Item/newifs.aspx?List=c723f511-be74-4a08-9c35-256c942f4b8e&Source=https%3A%2F%2Fportal%2Ecourtsquaregroup%2Ecom%2Fsites%2FClientPortal%2FSiteDirectory%2FLongeveron%2FBahamianEDC%2FLists%2FSAE%2520Report%2FAllItems%2Easpx&RootFolder=&Web=236453cf-66d3-498e-83ad-f27fb6084ab6&pid=' + vm.id;
    window.open(url, '_blank');
  };
  vm.viewSAE = function (row) {
    var url = 'https://studytst.lgvreg.com/sites/ortho/Lists/SAE%20Report/Item/displayifs.aspx?List=c723f511-be74-4a08-9c35-256c942f4b8e&Source=https%3A%2F%2Fportal%2Ecourtsquaregroup%2Ecom%2Fsites%2FClientPortal%2FSiteDirectory%2FLongeveron%2FBahamianEDC%2FLists%2FSAE%2520Report%2FAllItems%2Easpx&ContentTypeId=0x01007C3D3621847C0741A3CF69E701AA8BA8&ID=' + row.ID;
    window.open(url, '_blank');
  };
  ...
  vm.cancel = function () {
    document.location.href =
      "https://studytst.lgvreg.com/sites/ortho";
  };
