    ...
    <div ng-controller="csgCtl" ng-cloak>
      <div>
        <table>
          <tr>
            <td>
              <a href="https://studytst.lgvreg.com/sites/ortho">
          ...
          <div class="csg-content" id="b">
            <table border=0 width="100%">
              ...
              <tr>
                ...
                <td class="csg-label">
                  <div ng-show="d.visit == 0">Date of Infusion</div>
                  <div ng-show="d.visit != 0">Date of Follow-up</div>
                </td>
                <td>
                  ...
                  <div ng-show="d.visit != 0">
                    <input type="text" datepicker name="" id="" ng-model="d.injectRow[d.inject].followUpDate" </div>
                      </td> </tr> <tr>
              ...
              <tr>
                ...
                <td colspan="3">
                  <!-- Visit diagram -->
                  <img usemap="#image-map-base" src="short-base.png" alt="" ng-show="d.visit == 0" />
                  <img usemap="#image-map-30" src="short-30.png" alt="" ng-show="d.visit == 1" />
                  <img usemap="#image-map" src="short-90.png" alt="" ng-show="d.visit == 2" />


                  <!-- ImageMap -->
                  <map name="image-map-base">
                    <area target="" alt="" title="" href="javascript:void(0)" coords="2,5,146,70" shape="rect">
                    <area target="" alt="" title="" href="javascript:void(0)" ng-click="setVisit(1)"
                      coords="151,5,286,69" shape="rect">
                    <area target="" alt="" title="" href="javascript:void(0)" coords="289,4,427,70" shape="rect">
                  </map>

                  <!-- ImageMap -->
                  <map name="image-map-30">
                    <area target="" alt="" title="" href="javascript:void(0)" ng-click="setVisit(0)" coords="2,5,146,70"
                      shape="rect">
                    <area target="" alt="" title="" href="javascript:void(0)" coords="151,5,286,69" shape="rect">
                    <area target="" alt="" title="" href="javascript:void(0)" ng-click="setVisit(2)"
                      coords="289,4,427,70" shape="rect">
                  </map>
              ...
              <tr>
                <td class="csg-label">PCIC</td>
                <td>
                  <input type="text" maxlength="150" ng-model="d.injectRow[d.inject].visitRow[d.visit].med.PCIC" />
                </td>
                <td class="csg-label">PSQI</td>
                <td>
                  <input type="text" maxlength="150" ng-model="d.injectRow[d.inject].visitRow[d.visit].med.PSQI" />
                </td>
              </tr>
              <tr>
                <td class="csg-label">Knee</td>
                <td colspan="3">

                  <table>
                    <tr>
                      <td>Grade knee effusion</td>
                      <td>
                        <input type="text" maxlength="150"
                          ng-model="d.injectRow[d.inject].visitRow[d.visit].med.kneeEffusion" />
                      </td>
                    </tr>
                    <tr>
                      <td>Crepitus</td>
                      <td>
                        <select name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].med.kneeCrepitus">
                          <option>Yes</option>
                          <option>No</option>
                        </select>
                        <div ng-show="d.injectRow[d.inject].visitRow[d.visit].med.kneeCrepitus=='Yes'">
                          If yes:
                          <select name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].med.kneeSymp">
                    ...
                    <tr>
                      <td>Ligament Laxity</td>
                      <td>
                        <input type="text" maxlength="150"
                          ng-model="d.injectRow[d.inject].visitRow[d.visit].med.kneeLigament" />
                      </td>
                    </tr>
                    <tr>
                      <td>Medial Joint Line Tenderness</td>
                      <td>
                        <select name="" id="" ng-model="d.injectRow[d.inject].visitRow[d.visit].med.kneeTender">
                          <option>None</option>
                          <option>Mild</option>
              ...
              <tr>
                ...
                <td colspan="3">
                  <table>
                    ...
                    <tr>
                      <td>Harris Hip Score(HHS): </td>
                      <td>
                        <input type="text" maxlength="150"
                          ng-model="d.injectRow[d.inject].visitRow[d.visit].med.hhsleft" />
                      </td>
                      <td>
                        <input type="text" maxlength="150"
                          ng-model="d.injectRow[d.inject].visitRow[d.visit].med.hhsright" />
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                ...
                <td colspan="3">
                  <table>
                    ...
                    <tr>
                      <td>Foot and Ankle Outcome Score (FAOS): </td>
                      <td>
                        <input type="text" maxlength="150"
                          ng-model="d.injectRow[d.inject].visitRow[d.visit].med.FAOSleft" />
                      </td>
                      <td>
                        <input type="text" maxlength="150"
                          ng-model="d.injectRow[d.inject].visitRow[d.visit].med.FAOSright" />
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                <td class="csg-label">Shoulder</td>
                <td colspan="3">
                  <table>
                    <tr>
                      <td></td>
                    ...
                    <tr>
                      <td>Shoulder pain and disability index (SPADI): </td>
                      <td>
                        <input type="text" maxlength="150"
                          ng-model="d.injectRow[d.inject].visitRow[d.visit].med.SPADIleft" />
                      </td>
                      <td>
                        <input type="text" maxlength="150"
                          ng-model="d.injectRow[d.inject].visitRow[d.visit].med.SPADIright" />
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr>
                ...
                <td>
                  <select ng-model="d.injectRow[d.inject].visitRow[d.visit].med.ecg"
                    ng-options="x for x in choiceECG"></select>
                </td>
              </tr>
              <tr>
                <td class="csg-label">Brain MRI</td>
                <td>
                  <select ng-model="d.injectRow[d.inject].visitRow[d.visit].med.mri"
                    ng-options="x for x in choiceECG"></select>
                </td>
              </tr>
              <tr>
              ...
              <tr ng-show="d.visit == 0">
                <td colspan="4">
                  <h2>Injection Data</h2>
                </td>
              </tr>
              <tr ng-show="d.visit == 0">
                <td class="csg-label">Injection site</td>
                <td><input type="text" maxlength="150"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].med.injectSite" /></td>
                <td class="csg-label">PGIC</td>
                <td><input type="text" maxlength="150"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].med.injectPGIC" /></td>
              </tr>
              <tr ng-show="d.visit == 0">
                <td class="csg-label">Time of Collection</td>
                <td><input type="text" maxlength="150"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].med.injectTimeColl" /></td>
                <td class="csg-label">PSQI</td>
                <td><input type="text" maxlength="150"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].med.injectPSQI" /></td>
              </tr>
              <tr ng-show="d.visit == 0">
                <td class="csg-label">Time of Injection</td>
                <td><input type="text" maxlength="150"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].med.injectTime" /></td>
                <td></td>
                <td></td>
              </tr>
              <tr ng-show="d.visit == 0">
                <td class="csg-label">Dose of injection</td>
                <td><input type="text" maxlength="150"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].med.injectDose" /></td>
                <td></td>
                <td></td>
              </tr>
            ...
            <table>
              ...
              <tr>
                ...
                <td>
                  ...
                  <input tabindex="101" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.appearance" size="10">
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <!-- <select ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.color" ng-options="x for x in choiceUrinalysis"></select> -->
                  <input tabindex="102" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.color" size="10">
                </td>
                ...
                <td>
                  ...
                  <input tabindex="108" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.gravity" size="10">
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <input tabindex="103" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.clarity" size="10">
                </td>
                ...
                <td>
                  ...
                  <input tabindex="109" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.ph" size="10">
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <input tabindex="104" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.bili" size="10">
                </td>
                ...
                <td>
                  ...
                  <input tabindex="110" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.ketones" size="10">
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <input tabindex="104" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.nitrates" size="10">
                </td>
                ...
                <td>
                  ...
                  <input tabindex="111" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.urinewbc" size="10">/HPF
              ...
              <tr>
                ...
                <td>
                  ...
                  <input tabindex="105" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.leuk" size="10">
                </td>
                ...
                <td>
                  ...
                  <input tabindex="112" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.rbc" size="10">/HPF
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <input tabindex="106" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.glucose" size="10">
                </td>
                ...
                <td>
                  ...
                  <input tabindex="113" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.epithetial" size="10">/HPF
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <input tabindex="107" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.protein" size="10">
                </td>
                ...
                <td>
                  ...
                  <input tabindex="114" type="text" name="" id=""
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.bacteria" size="10">/HPF
                </td>
              </tr>
              <!-- <tr>
              ...
              <tr>
                <td class="csg-label">General Notes</td>
                <td colspan="4">
                  <textarea tabindex="115" ng-model="d.injectRow[d.inject].visitRow[d.visit].uri.notes" name="" id=""
          ...
          <div class="csg-content" id="e">
            <table border="0">
              ...
              <tr>
                ...
                <td class="csg-wrap">
                  <input tabindex="202" type="text" size="10"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.wbc" />thousand/uL
                </td>
                <td class="csg-label">RDW</td>
                <td>
                  <input tabindex="207" type="text" size="10"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.rdw" />%
                </td>
              </tr>
              ...
              <tr>
                ...
                <td class="csg-wrap">
                  <input tabindex="203" type="text" size="10"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.rbc" />million/uL
                </td>
                <td class="csg-label">MCHC</td>
                <td>
                  <input tabindex="208" type="text" size="10"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.mchc" />g/dL
                </td>
              </tr>
              <tr>
                <td class="csg-label">Hbg</td>
                <td class="csg-wrap">
                  <input tabindex="204" type="text" size="10"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.hbg" />g/dL
                </td>
                <td class="csg-label">MPV</td>
                <td>
                  <input tabindex="209" type="text" size="10"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.mpv" />fL
                </td>
              </tr>
              <tr>
                <td class="csg-label">Hct</td>
                <td class="csg-wrap">
                  <input tabindex="205" type="text" size="10"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].cbc.hct" />%
                </td>
          ...
          <div class="csg-content" id="f">
            <table>
              ...
              <tr>
                ...
                <td class="csg-wrap">
                  <input tabindex="310" type="number"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.chloride" />
                  mmol/L
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td class="csg-wrap">
                  <input tabindex="305" type="number"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.totalprotein" />
                  g/dL
                </td>
              ...
              <tr>
                ...
                <td class="csg-wrap">
                  <input tabindex="307" type="number"
                    ng-model="d.injectRow[d.inject].visitRow[d.visit].chem.potassium" />
                  mmol/L
                </td>
                ...
                <td colspan="4">
                  ...
                  <table border="0" width="100%">
                    ...
                    <tr ng-repeat="r in respSAE">
                      ...
                      <td>
                        <a
                          href="https://studytst.lgvreg.com/sites/ortho/Lists/SAE%20Report/Item/displayifs.aspx?List=c723f511-be74-4a08-9c35-256c942f4b8e&Source=https%3A%2F%2Fportal%2Ecourtsquaregroup%2Ecom%2Fsites%2FClientPortal%2FSiteDirectory%2FLongeveron%2FBahamianEDC%2FLists%2FSAE%2520Report%2FAllItems%2Easpx&ContentTypeId=0x01007C3D3621847C0741A3CF69E701AA8BA8&ID={{r.id}}">{{r.Title}}</a>
                      </td>
                      <td>{{r.Created}}</td>
                      <td>
