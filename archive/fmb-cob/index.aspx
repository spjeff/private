...
<body ng-app="cobApp">
    ...
    <div ng-controller="cobCtl">
        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                ...
                <ul class="fmb-purple nav navbar-nav">
                    ...
                    <li>
                        <a href="#/guarantor/?id={{id}}" ng-click="save()">Guarantor</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#/odata/?id={{id}}" ng-click="save()">Outbound Data Exchange</a>
                    </li>
                    <li>
                        <a href="#/idata/?id={{id}}" ng-click="save()">Inbound Data Exchange</a>
                    </li>
                    <li>
                        <a href="#/daylight/?id={{id}}" ng-click="save()">Daylight Overdraft</a>
                    </li>
                    <li>
                        <a href="#/reposweep/?id={{id}}" ng-click="save()">Repo Sweep</a>
                    </li>
                    <li>
                        <a href="#/mmsweep/?id={{id}}" ng-click="save()">Money Market Mutual Fund Sweep</a>
                    </li>
                    <li>
                        <a href="#/repwire/?id={{id}}" ng-click="save()">Repetitive Wire Transfer</a>
                    </li>
                </ul>
            </div>
        </nav>
        ...
        <div style="text-align:right" class="fmb-status">
            Status:
            <select name="" id="" ng-model="d.formStatus" ng-options="x for x in choiceStatus" ng-change="updateStatus()">
            </select>
            <input type="text" name="" id="" ng-model="d.formStatusClosedComment" ng-show="d.formStatus == 'Closed'" placeholder="Provide reason why closed">
        </div>
