    ...
    <div ng-controller="csgCtl" ng-cloak>
      <div>
        <table>
          <tr>
            <td>
              <a href="https://studytst.lgvreg.com/sites/alz">
        ...
        <div id="tabs">
          ...
          <div class="csg-content" id="b">
            <table border=0 width="100%">
              ...
              <tr ng-hide="d.visit == 1">
                <td class="csg-label">MoCA</td>
                <td>
                  <input type="text" maxlength="150" ng-model="d.injectRow[d.inject].visitRow[d.visit].med.moca" />
                </td>
              </tr>
              <tr ng-hide="d.visit == 1">
                <td class="csg-label">TMT-A</td>
                <td>
                  <input type="text" maxlength="150" ng-model="d.injectRow[d.inject].visitRow[d.visit].med.tmta" />
                </td>
                <td class="csg-label">TMT-B</td>
                <td>
                  <input type="text" maxlength="150" ng-model="d.injectRow[d.inject].visitRow[d.visit].med.tmtb" />
                </td>
              </tr>  
              <tr ng-hide="d.visit == 1">
                <td class="csg-label">QOL-AD (Subject)</td>
                <td>
                  <input type="text" maxlength="150" ng-model="d.injectRow[d.inject].visitRow[d.visit].med.subject" />
                </td>
                <td class="csg-label">QOL-AD (Caregiver)</td>
                <td>
                  <input type="text" maxlength="150" ng-model="d.injectRow[d.inject].visitRow[d.visit].med.caregive" />
                </td>
              </tr>
              ...
              <tr ng-hide="d.visit == 1">
                  ...
                  <td>
                    <select ng-model="d.injectRow[d.inject].visitRow[d.visit].med.mri" ng-options="x for x in choiceECG"></select>
                  </td>
                </tr>
              <tr ng-hide="d.visit == 1">
                ...
                <td colspan="4">
                  ...
                  <table border="0" width="100%">
                    ...
                    <tr ng-repeat="r in respSAE">
                      ...
                      <td>
                        <a
                          href="https://studytst.lgvreg.com/sites/alz/Lists/SAE%20Report/Item/displayifs.aspx?List=c723f511-be74-4a08-9c35-256c942f4b8e&Source=https%3A%2F%2Fportal%2Ecourtsquaregroup%2Ecom%2Fsites%2FClientPortal%2FSiteDirectory%2FLongeveron%2FBahamianEDC%2FLists%2FSAE%2520Report%2FAllItems%2Easpx&ContentTypeId=0x01007C3D3621847C0741A3CF69E701AA8BA8&ID={{r.id}}">{{r.Title}}</a>
                      </td>
                      <td>{{r.Created}}</td>
                      <td>
